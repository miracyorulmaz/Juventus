...
import { Award, CalendarDays, Clock, Sparkles, Target, TrendingUp, Trophy, Users } from 'lucide-react';
import type { TrainingProgram } from '@/types/database';

const icons = [Sparkles, TrendingUp, Award, Trophy, CalendarDays, Target];
